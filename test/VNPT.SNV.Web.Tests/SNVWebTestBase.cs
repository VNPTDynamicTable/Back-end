...
using VNPT.SNV.Models.TokenAuth;
...
public abstract class SNVWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
{
    protected static readonly Lazy<string> ContentRootFolder;

    static SNVWebTestBase()
    {
    ...
    protected override IWebHostBuilder CreateWebHostBuilder()
    {
        return base
            ...
            .UseSetting(WebHostDefaults.ApplicationKey, typeof(SNVWebMvcModule).Assembly.FullName);
    }
    ...
    {
        using (var context = IocManager.Resolve<SNVDbContext>())
        {
            action(context);
            context.SaveChanges();
        }
    ...
    protected async Task UsingDbContextAsync(Func<SNVDbContext, Task> action)
    {
        using (var context = IocManager.Resolve<SNVDbContext>())
        {
    ...
    protected async Task<T> UsingDbContextAsync<T>(Func<SNVDbContext, Task<T>> func)
    {
        T result;
